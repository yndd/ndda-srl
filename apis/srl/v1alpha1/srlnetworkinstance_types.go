...
type Networkinstance struct {
	...
	// NetworkinstanceIploadbalancing
...
type NetworkinstanceBridgetable struct {
	...
	// NetworkinstanceBridgetableStaticmac
...
type NetworkinstanceBridgetableStaticmac struct {
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceBridgetableStaticmacMac
...
type NetworkinstanceIploadbalancing struct {
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceIploadbalancingResilienthashprefix
...
type NetworkinstanceProtocolsDirectlyconnected struct {
	// NetworkinstanceProtocolsDirectlyconnectedTedatabaseinstall
...
type NetworkinstanceProtocolsLdpDiscovery struct {
	// NetworkinstanceProtocolsLdpDiscoveryInterfaces
...
type NetworkinstanceProtocolsLdpDiscoveryInterfaces struct {
	...
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceProtocolsLdpDiscoveryInterfacesInterface
...
type NetworkinstanceProtocolsLdpDiscoveryInterfacesInterface struct {
	...
	// +kubebuilder:default:=5
	Hellointerval *uint16 `json:"hello-interval,omitempty"`
	// NetworkinstanceProtocolsLdpDiscoveryInterfacesInterfaceIpv4
...
type NetworkinstanceProtocolsLdpDiscoveryInterfacesInterfaceIpv4Statistics struct {
	// NetworkinstanceProtocolsLdpDiscoveryInterfacesInterfaceIpv4StatisticsHellomessageerrors
...
type NetworkinstanceProtocolsLdpIpv4 struct {
	// NetworkinstanceProtocolsLdpIpv4Fecresolution
...
type NetworkinstanceProtocolsLdpPeers struct {
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceProtocolsLdpPeersPeer
	...
	// NetworkinstanceProtocolsLdpPeersTcptransport
...
type NetworkinstanceProtocolsLdpPeersPeerReceivedcapabilities struct {
	...
	// NetworkinstanceProtocolsLdpPeersPeerReceivedcapabilitiesStateadvertisementcontrol
...
type NetworkinstanceProtocolsLdpPeersPeerTcptransport struct {
	// NetworkinstanceProtocolsLdpPeersPeerTcptransportAuthentication
...
type NetworkinstanceProtocolsLdpPeersTcptransport struct {
	// NetworkinstanceProtocolsLdpPeersTcptransportAuthentication
...
type NetworkinstanceProtocolsLdpTraceoptions struct {
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceProtocolsLdpTraceoptionsInterface
	Interface []*NetworkinstanceProtocolsLdpTraceoptionsInterface `json:"interface,omitempty"`
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceProtocolsLdpTraceoptionsPeer
...
type NetworkinstanceSegmentrouting struct {
	// NetworkinstanceSegmentroutingMpls
...
type NetworkinstanceTepolicies struct {
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceTepoliciesStaticpolicy
...
type NetworkinstanceTepoliciesStaticpolicy struct {
	...
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceTepoliciesStaticpolicySegmentlist
...
type NetworkinstanceTepoliciesStaticpolicySegmentlist struct {
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceTepoliciesStaticpolicySegmentlistSegment
...
type NetworkinstanceTrafficengineering struct {
	// NetworkinstanceTrafficengineeringAdmingroups
	...
	// NetworkinstanceTrafficengineeringSharedrisklinkgroups
...
type NetworkinstanceTrafficengineeringSharedrisklinkgroupsGroup struct {
	...
	//+kubebuilder:validation:MinItems=0
	//+kubebuilder:validation:MaxItems=1024
	// NetworkinstanceTrafficengineeringSharedrisklinkgroupsGroupStaticmember
